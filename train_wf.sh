...
# python train_vertex_t1_xy.py --config config_jsns2_positron_1to10_1207data.yaml -o 20221226_xy_test --device 0 --epoch 3000 --batch 256 --lr 1e-4 --seed 12345 --model DGCNN6_homo2 --fea 2 --cla 2 --geo 1 --itype 0 --ftype 1

python eval_vertex_t1_xy.py --config config_jsns2_positron_1to10_1207data.yaml  -o 20221226_xy_test --device 0 --seed 12345 --batch 1 --geo 1 --itype 0  --ftype 1 --cla 2
