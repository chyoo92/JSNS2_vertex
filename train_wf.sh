#!/bain/bash
python train_vertex_t1.py --config config_test.yaml -o 20221130_code_clean --device 3 --epoch 200 --batch 64 --lr 1e-4 --seed 12345 --model GNN1layer_wf --fea 248 --cla 3
