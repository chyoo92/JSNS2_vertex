...
jade_path1 = '/store/hep/JSNS2/raw_cw/Jade_data/r00'+str(run_num)+'/prod_ver0/Run_00'+str(run_num)+'/'
jade_path2 = '/store/hep/JSNS2/raw_cw/Jade_data/r00'+str(run_num)+'/reco_ver0/Run_00'+str(run_num)+'/'
output_path = '/store/hep/users/yewzzang/JSNS2/ch_1563_data/'
...
parser.add_argument('--runnum', action='store', type=int)


args = parser.parse_args()


raw_file = 'debug.r00'+str(run_num)+'.f'+ '{0:05d}'.format(args.runnum)+'.root'
prod_file = 'jade_ver0_r00'+str(run_num)+'_s'+ '{0:05d}'.format(args.runnum)+'.root'
reco_file = 'Reco_jade_ver0_r00'+str(run_num)+'_s'+ '{0:05d}'.format(args.runnum)+'.root'


output = output_path + 'r00'+str(run_num)+'_ch_data_'+ '{0:05d}'.format(args.runnum)+'.h5'
...
for events in tqdm(range(waveform.shape[0])):
