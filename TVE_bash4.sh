...
python train_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl3_k10_0 --device 3 --epoch 1000 --batch 256 --lr 1e-4 --seed 12345 --model DGCNN_type1 --geo 1 --itype 0 --tev 1 --fea 1 --pools 0 --aggr max --cla 3 --edge 10 --depths 5 --loss maxabs3

python eval_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl3_k10_0 --device 3 --seed 12345 --batch 1 --geo 1 --itype 0 --tev 0 --cla 3


# python train_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl1_k10_0 --device 3 --epoch 1000 --batch 256 --lr 1e-4 --seed 12345 --model DGCNN_type1 --geo 1 --itype 0 --tev 1 --fea 1 --pools 0 --aggr max --cla 1 --edge 10 --depths 5 --loss maxabs

# python eval_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl1_k10_0 --device 3 --seed 12345 --batch 1 --geo 1 --itype 0 --tev 0 --cla 1


python train_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl4_k10_0 --device 3 --epoch 1000 --batch 256 --lr 1e-4 --seed 12345 --model DGCNN_type1 --geo 1 --itype 0 --tev 1 --fea 1 --pools 0 --aggr max --cla 4 --edge 10 --depths 5 --loss maxabs4

python eval_model.py --config config_jsns2_positron_1to10_0113data.yaml -o 20230220_type1_maxabs_loss_cl4_k10_0 --device 3 --seed 12345 --batch 1 --geo 1 --itype 0 --tev 0 --cla 4
