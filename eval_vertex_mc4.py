...
if args.dtype == 1:
    ...
    from dataset.vertexdataset_mc_h5_3 import *
    dset = vertexdataset_mc_h5_3()   
...
for i, (data, jv,en) in enumerate(tqdm(testLoader)):
