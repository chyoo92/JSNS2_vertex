...
class image_graph(nn.Module):
    def __init__(self,**kwargs):
        super(image_graph, self).__init__()
        ...
        self.lin1 = torch.nn.Sequential(
                torch.nn.Linear(64*(self.depths), 512),
                torch.nn.ReLU(),
        ...
        self.cnn1 = nn.Sequential(
            nn.Conv1d(1, 1, kernel_size=11),

        )
        
        self.cnn2 = nn.Sequential(
            nn.Conv1d(192, 192, kernel_size=11),
...
#         print(xxx_1)
        ...
        xxx_1 = self.cnn1(x[0,:].reshape(1,-1))
        print(xxx_1)
        print(xxx_1.shape)
