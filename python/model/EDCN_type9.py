...
class EDCN_type9(nn.Module):
    def __init__(self,**kwargs):
        super(EDCN_type9, self).__init__()
        ...
        self.lin1 = torch.nn.Sequential(
                torch.nn.Linear(32*(self.depths), 512),
                torch.nn.ReLU(),
    ...
    def forward(self, data):
        ...
        out1 = global_max_pool(self.lin1(comb_fea), batch)
        out2 = global_mean_pool(self.lin1(comb_fea), batch)
